...
public class ParameterizedSqlExample {
  ...
  public static void main(String[] args) {
    ...
    ParameterizedSql psql1 = ParameterizedSql.withOrderedParameters(sql, "Alice", "Kyoto");
    ParameterizedSql psql2 =
        ParameterizedSqlBuilder.orderedParameterBuilder(sql)
    ...
    ParameterizedSql psql3 =
        ParameterizedSql.withNamedParameters(
            "insert into customer values(:id,:name,:address)",
