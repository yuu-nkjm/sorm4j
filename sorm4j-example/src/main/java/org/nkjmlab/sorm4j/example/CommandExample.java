...
public class CommandExample {
  ...
  public static void main(String[] args) {
    ...
    sorm.apply(conn -> conn.createCommand("insert into customer values(?,?,?)")
    ...
    sorm.apply(conn -> conn.createCommand("insert into customer values(:id,:name,:address)")
