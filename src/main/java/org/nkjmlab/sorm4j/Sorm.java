...
public interface Sorm {
   ...
   * {@link SormFactory#registerNewConfig(String, java.util.function.Consumer)} or
   * {@link SormFactory#registerNewModifiedConfig(String, Sorm, java.util.function.Consumer)}
   *
   * @param configName
   * @return
   */
