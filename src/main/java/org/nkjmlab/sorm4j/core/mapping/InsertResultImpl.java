...
public final class InsertResultImpl<T> implements InsertResult<T> {
   ...
   */
  public InsertResultImpl(int[] rowsModified, T lastInsertedObject, List<Object> autoGeneratedKeys) {
  ...
  /**
   * Gets an empty {@link InsertResultImpl}.
   *
   * @param <T>
   * @return
   */
  public static <T> InsertResult<T> emptyInsertResult() {
    return new InsertResultImpl<T>(new int[] {0}, null, Collections.emptyList());
  }
