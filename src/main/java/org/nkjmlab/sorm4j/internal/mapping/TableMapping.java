...
public final class TableMapping<T> extends Mapping<T> {
  ...
  public TableMapping(SormOptions options, ResultSetConverter resultSetConverter,
      Class<T> objectClass, ColumnToAccessorMap columnToAccessorMap,
      SqlParameterSetter sqlParameterSetter, MultiRowProcessorFactory multiRowProcessorFactory,
      TableMappingSql sql) {
  ...
  private int executeUpdate(Connection connection, String sql, final Object... parameters) {
    ...
    int ret = OrmConnectionImpl.executeUpdateAndClose(options, connection, sqlParameterSetter, sql,
        parameters);
    dp.ifPresent(lp -> {
  ...
  public InsertResult<T> insertAndGet(Connection connection, T object) {
    ...
    try (PreparedStatement stmt =
      ...
      sqlParameterSetter.setParameters(options, stmt, getInsertParameters(object));
