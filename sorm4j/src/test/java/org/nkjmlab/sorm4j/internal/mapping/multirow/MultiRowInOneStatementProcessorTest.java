...
import static org.nkjmlab.sorm4j.mapping.MultiRowProcessorFactory.MultiRowProcessorType.*;
...
class MultiRowInOneStatementProcessorTest {
  ...
  private static List<Sorm> sorms = List.of(SIMPLE_BATCH, MULTI_ROW, MULTI_ROW_AND_BATCH).stream()
      .map(type -> SormTestUtils.createSormWithNewContextAndTables(SormContext.builder()
