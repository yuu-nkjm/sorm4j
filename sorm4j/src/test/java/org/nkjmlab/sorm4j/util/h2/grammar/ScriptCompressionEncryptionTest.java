...
import org.junit.jupiter.api.Test;
 ...
 class ScriptCompressionEncryptionTest {
    ...
    public void testDefaultBuilder() {
        ...
        ScriptCompressionEncryption script = ScriptCompressionEncryption.defaultBuilder(password).build();
    ...
    public void testBuilderWithCustomCompression() {
        ScriptCompressionEncryption script = new ScriptCompressionEncryption.Builder()
                .compression("ZIP")
                .password("pass")
                .build();
