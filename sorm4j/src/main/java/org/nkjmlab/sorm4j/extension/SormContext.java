...
public final class SormContext {
  ...
  public static final SormContext DEFAULT_CONTEXT = SormContext.newBuilder().build();
  ...
  public <T> TableMapping<T> createTableMapping(Class<T> objectClass, String tableName,
    ...
    TableMetaData tableMetaData = new TableMetaDataImpl(tableName, columnAliasPrefix, columns,
    ...
    Map<String, Accessor> aliasAccessors =
        sormConfig.getColumnFieldMapper().createAliasAccessors(columnAliasPrefix, accessors);

    ColumnToAccessorMap columnToAccessorMap =
        new ColumnToAccessorMap(objectClass, accessors, columnAliasPrefix, aliasAccessors);
