...
public final class TableMetaDataImpl implements TableMetaData {
  ...
  public TableMetaDataImpl(String tableName, String columnAliasPrefix,
      List<ColumnMetaData> columnsWithMetaData, List<String> primaryKeys,
    ...
    this.notPrimaryKeys = Collections.unmodifiableList(
        columns.stream().filter(col -> !primaryKeys.contains(col)).collect(Collectors.toList()));

    this.columnsForUpdate = Collections.unmodifiableList(
  ...
  public String toString() {
    return "TableMetaDataImpl [tableName=" + tableName + ", columns=" + columns + ", primaryKeys="
        + primaryKeys + ", autoGeneratedColumns=" + autoGeneratedColumns + ", hasPrimaryKey="
        + hasPrimaryKey + ", hasAutoGeneratedColumns=" + hasAutoGeneratedColumns
        + ", notAutoGeneratedColumns=" + notAutoGeneratedColumns + ", columnsForUpdate="
        + columnsForUpdate + ", autoGeneratedColumnsArray="
        + Arrays.toString(autoGeneratedColumnsArray) + ", notPrimaryKeys=" + notPrimaryKeys
        + ", columnsWithAliases=" + columnsWithAliases + ", columnsWithMetaData="
        + columnsWithMetaData + "]";
  }
